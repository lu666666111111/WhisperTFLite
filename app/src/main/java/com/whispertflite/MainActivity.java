...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String modelPath;
        String vocabPath;
        boolean useMultilingual = false;/*true*/;//false; // TODO: change multilingual flag as per model used
        if (useMultilingual) {
        ...
        mRecorder.setListener(new IRecorderListener() {
            @Override
            public void onUpdateReceived(String message) {//todo 注释掉
                /*Log.d(TAG, "Update is received, Message: " + message);
                handler.post(() -> tvStatus.setText(message));
...
//        testParallelProcessing();
        ...
        runOnUiThread(()->startRecordingRe());
    }
